<?php
    ...
    //zabezpieczenie przed dostaniem sie niezalogowanego usera:
...
<head>
    ...
    <title>Main menu - $CashFlowControl</title>
        ...
        <div class="container ">
            <div class="row d-flex justify-content-center" style="background-color: #F1FAEE">
                <div class="col-6 py-2 d-flex justify-content-center">
                    <button type="button" class="btn btn-danger-dark border border-dark btn-lg" style="background-color: #A8DADC" id="BSbutton">Balance Sheet</button>
                </div>   
            </div>       
        </div>
    </section>
